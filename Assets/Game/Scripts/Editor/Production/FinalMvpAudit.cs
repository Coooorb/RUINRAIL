    ...
    public static class FinalMvpAudit
    {
        ...
        public sealed class Report
        {
            ...
            public string ToMarkdown()
            {
                ...
                sb.AppendLine();
                sb.AppendLine("Scope: the MVP content/engineering requirements, regenerated by every EditMode run. The release-candidate status (built-player scenarios, co-op proofs, smoke stability) is `production/FINAL_RELEASE_CANDIDATE_AUDIT.md`.");
                sb.AppendLine();
