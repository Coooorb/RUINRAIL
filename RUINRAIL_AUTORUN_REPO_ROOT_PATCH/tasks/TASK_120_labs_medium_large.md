# TASK 120 — Overgrown Labs Rooms — Medium and Large Combat
...
- TASK 119 must be complete or independently audited as already satisfied.
- Preserve the confirmed implementation state from all earlier completed tasks.
- If an earlier dependency is missing or broken, stop and report the dependency failure instead of inventing a substitute architecture.

## GOAL

Author the Overgrown Labs medium/large Combat room-prefab subset using the validated room pipeline.
...
1. Create exactly 4 Medium Combat + 2 Large Combat; every prefab is tagged Overgrown Labs, has a unique stable room ID and correct category.
...
1. Exactly 4 Medium Combat + 2 Large Combat validated Overgrown Labs rooms exist in this subset.
...
In normal single-task mode, stop before TASK 121. Under `production/130_AUTONOMOUS_TASK_RUNNER.md`, write the checkpoint to the autonomous run log and continue only if the runner's gate rules permit it.
