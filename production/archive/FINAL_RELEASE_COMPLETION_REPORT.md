...
> **SUPERSEDED — historical document (2026-09-25).** Current release status: `production/CURRENT_RELEASE_STATUS.md` (detailed audit: `production/archive/FINAL_RELEASE_CANDIDATE_AUDIT.md`). Its content blockers (0/53 clips, white-square effects, placeholder font) were resolved by later passes. The body below is kept unchanged as the record of its time.
