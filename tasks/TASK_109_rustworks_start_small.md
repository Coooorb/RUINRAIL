# TASK 109 — Rustworks Rooms — Start and Small Combat
...
- TASK 108 must be complete or independently audited as already satisfied.
- Preserve the confirmed implementation state from all earlier completed tasks.
- If an earlier dependency is missing or broken, stop and report the dependency failure instead of inventing a substitute architecture.

## GOAL

Author the Rustworks Start and small Combat room-prefab subset using the validated room pipeline.
...
1. Create exactly 2 Start + 5 Small Combat; every prefab is tagged Rustworks, has a unique stable room ID and correct category.
...
1. Exactly 2 Start + 5 Small Combat validated Rustworks rooms exist in this subset.
...
In normal single-task mode, stop before TASK 110. Under `production/130_AUTONOMOUS_TASK_RUNNER.md`, write the checkpoint to the autonomous run log and continue only if the runner's gate rules permit it.
